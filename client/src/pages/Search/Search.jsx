...
//       try {
//         const response = await api.get("product/getBrands");
//         if (response.data.success) {
...
//       isPopular: isPopularProduct || undefined,
...
//       setIsFilterApplied(hasFilters || hasSearchTerm);
...
//       // Update URL params
//       const params = {};
//       if (term && term.trim()) params.q = term;
//       if (selectedCategory) params.category = selectedCategory;
//       if (selectedBrand) params.brand = selectedBrand;
//       if (priceRange.min) params.minPrice = priceRange.min;
//       if (priceRange.max) params.maxPrice = priceRange.max;
...
//     getActiveFilterCount() > 0 || searchTerm.trim().length >= 2;
